...
### 優先度高
- [ ] 曲タイトルの文字サイズをスライドバーで調整
- [ ] アーティスト名の文字サイズをスライドバーで調整
- [ ] フォント選択機能（日本語フォント対応）

### 優先度中
- [ ] テキストの位置を微調整できるスライドバー
- [ ] カスタムカラーピッカー（文字色・縁取り色）
- [ ] テキストスタイルのプリセット保存/読み込み
...
## 現在の実装状況（2025-12-12時点）

### 完了
- 背景画像の選択・表示
- テキストスタイル5種類（インパクト/ポップ/シンプル/エレガント/ネオン）
- テキスト配置5種類（左上/左中/左下/中央/右寄せ）
- メインテキスト（曲タイトル、アーティスト名）
- オプションテキスト（副題、公開日、曲の説明）
- PNG/JPEG出力
